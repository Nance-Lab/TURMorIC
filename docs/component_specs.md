...
Pages of GUI:
    ...
    •	hirdPageA: Aligns boundaries to remove rotational variance 
...
### **Inputs**  
- **Raw microscopy images** in formats such as **TIFF, PNG, JPEG, BMP**.  
...
## **2. Segmentation & Quantification Component**  
...
- **Segmentation parameters**, either **user-defined** or **automatically adjusted** using adaptive thresholding.  
- **Ground truth data** (if available) for validation and segmentation accuracy improvements.  

### **Outputs**  
- **Segmented images** with labeled cellular structures.  
- **Quantitative datasets**, including:  
  - **Cell count**  
...
## **3. Adaptive Thresholding Component**  
...
### **Side effects**  
- **Processing multiple images requires high memory and computational power**, impacting performance.  

---

## **6. Data Export API Component**  
